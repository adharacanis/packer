...
static void Color_obj_sVisitStatic(HX_VISIT_PARAMS) {
...
hx::Static(__mClass) = hx::_hx_RegisterClass(HX_HCSTRING("format.png.Color","\xc7","\x1f","\x84","\x10"), hx::TCanCast< Color_obj >,Color_obj_sStaticFields,0,
	&__Create_Color_obj, &__Create,
	&super::__SGetClass(), &CreateColor_obj, Color_obj_sMarkStatics
#ifdef HXCPP_VISIT_ALLOCS
    , Color_obj_sVisitStatic
#endif
...
{
ColIndexed = hx::CreateEnum< Color_obj >(HX_HCSTRING("ColIndexed","\xb1","\x8f","\x82","\x99"),2,0);
}
