...
static void Chunk_obj_sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(Chunk_obj::CEnd,"CEnd");
};

#ifdef HXCPP_VISIT_ALLOCS
static void Chunk_obj_sVisitStatic(HX_VISIT_PARAMS) {
...
hx::Static(__mClass) = hx::_hx_RegisterClass(HX_HCSTRING("format.png.Chunk","\xd1","\x74","\xea","\x0b"), hx::TCanCast< Chunk_obj >,Chunk_obj_sStaticFields,0,
	&__Create_Chunk_obj, &__Create,
	&super::__SGetClass(), &CreateChunk_obj, Chunk_obj_sMarkStatics
#ifdef HXCPP_VISIT_ALLOCS
    , Chunk_obj_sVisitStatic
#endif
...
{
CEnd = hx::CreateEnum< Chunk_obj >(HX_HCSTRING("CEnd","\x58","\x07","\x7e","\x2c"),0,0);
}
