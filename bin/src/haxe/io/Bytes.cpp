...
HX_LOCAL_STACK_FRAME(_hx_pos_464b3142acc6d207_126_fill,"haxe.io.Bytes","fill",0xd33b42c6,"haxe.io.Bytes.fill","C:\\HaxeToolkit\\haxe\\std/haxe/io/Bytes.hx",126,0x20b05d0c)
...
HX_LOCAL_STACK_FRAME(_hx_pos_464b3142acc6d207_466_alloc,"haxe.io.Bytes","alloc",0x2199ead2,"haxe.io.Bytes.alloc","C:\\HaxeToolkit\\haxe\\std/haxe/io/Bytes.hx",466,0x20b05d0c)
HX_LOCAL_STACK_FRAME(_hx_pos_464b3142acc6d207_494_ofString,"haxe.io.Bytes","ofString",0x6e53bb0b,"haxe.io.Bytes.ofString","C:\\HaxeToolkit\\haxe\\std/haxe/io/Bytes.hx",494,0x20b05d0c)
namespace haxe{
namespace io{
...
void Bytes_obj::fill(int pos,int len,int value){
            	HX_STACKFRAME(&_hx_pos_464b3142acc6d207_126_fill)
HXDLIN( 126)		::__hxcpp_memory_memset(this->b,pos,len,value);
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(Bytes_obj,toString,return )
 ...
 ::haxe::io::Bytes Bytes_obj::alloc(int length){
            	HX_GC_STACKFRAME(&_hx_pos_464b3142acc6d207_466_alloc)
HXLINE( 476)		::Array< unsigned char > a = ::Array_obj< unsigned char >::__new();
HXLINE( 477)		if ((length > (int)0)) {
HXLINE( 477)			_hx_array_set_size_exact(a,length);
            		}
HXLINE( 478)		return  ::haxe::io::Bytes_obj::__alloc( HX_CTX ,length,a);
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Bytes_obj,alloc,return )
 ...
 ::haxe::io::Bytes Bytes_obj::ofString(::String s){
            	HX_GC_STACKFRAME(&_hx_pos_464b3142acc6d207_494_ofString)
HXLINE( 505)		::Array< unsigned char > a = ::Array_obj< unsigned char >::__new();
HXLINE( 506)		::__hxcpp_bytes_of_string(a,s);
HXLINE( 507)		return  ::haxe::io::Bytes_obj::__alloc( HX_CTX ,a->length,a);
            	}
