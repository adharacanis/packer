...
class HXCPP_CLASS_ATTRIBUTES Inflate_obj : public hx::Object
{
	...
	public:
		...
		hx::ObjectPtr< Inflate_obj > __new() {
			hx::ObjectPtr< Inflate_obj > __this = new Inflate_obj();
			__this->__construct();
			return __this;
		}

		static hx::ObjectPtr< Inflate_obj > __alloc(hx::Ctx *_hx_ctx) {
		...
		::String __ToString() const { return HX_HCSTRING("Inflate","\x67","\xc4","\x6c","\xd9"); }
